...
function Home() {
  return (
    <div className="flex-1 px-6 pb-6 justify-between flex flex-col h-screen bg-sky-900">
      <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
        <div className="relative flex items-center space-x-4">
          <div className="relative">
              ...
              <img src="elon.png" alt="" className="w-10 sm:w-12 h-10 sm:h-12 rounded-full" />
          </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <button type="button" className="inline-flex items-center justify-center rounded-lg border-none h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-100 focus:outline-none">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <a href='https://Twitter.com/supportboterc'>
